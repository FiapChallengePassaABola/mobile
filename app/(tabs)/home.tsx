    ...
    <View className="w-80 h-20 bg-primaria rounded-[30px] justify-center flex-row">
      <View className="flex justify-center  items-start w-[70%] gap-1">
        ...
        <View className="flex-row justify-start w-full gap-10">
          <Text className="color-white text-xs font-thin border rounded-full border-white/50 w-12 text-center">
            {duration}min
          </Text>
  ...
  return (
    <BackgroundScreen>
      ...
      <View className="flex-1 w-screen items-center gap-5 p-4">
        <Text className="color-white text-4xl font-semibold mt-5 border-b-2 border-[#d9d9d9]/25 w-[90%] text-center h-14">
          Treino de hoje
        </Text>
